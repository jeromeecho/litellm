...
- [LiteLLM 自学教程：从一次成功调用到理解模型网关](litellm-self-study-tutorial.md)，适合只完成 Quick Start 的学习者，逐章讲解概念、实验、预期结果、排错与自测
...
如果已经完成单模型 Quick Start，先读自学教程，从请求链路与配置逐步学习协议、权限、路由、预算、缓存和监控。需要快速建立整体认识时看介绍 PPT，需要集中查阅原理与参数时看学习手册，遇到 Foundry 或 Codex 接入问题时查阅对应专题
